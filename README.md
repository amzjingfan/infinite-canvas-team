...
团队仓库：<https://github.com/amzjingfan/infinite-canvas-team>。首次安装和日常更新请阅读 [团队发布指南](docs/team-releases.md)。使用 Releases 更新程序，不使用 git pull 覆盖同事的运行目录。密钥、画布、素材与账号登录不进入源码仓库或发布资产。

基于原作者 [hero8152/Infinite-Canvas](https://github.com/hero8152/Infinite-Canvas) 开发，保留原 LICENSE 及以下上游介绍。团队改动用于公司内部协作，许可证未更改。
